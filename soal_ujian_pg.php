...
if ($_SERVER["REQUEST_METHOD"]=='POST') {
    ...
    if($kodepg=='' || $kmapel=='' || $soal=='' || $a=='' || $b=='' || $c=='' || $d=='' || $kunci=='' || $tanggal==''){
        ...
        if($simpan){
            echo "<script>window.location.href='jawabpg?id_pg='<?= $_GET[id_upg] ?>.php'</script>";
        }
...
<label></label>
<?php  $tampil=mysqli_query($koneksi,"SELECT * FROM ujian_pg WHERE kode_pg='$_GET[id_upg]' ");
while($dm=mysqli_fetch_array($tampil)){ ?>
<input type="text" name="kode_pg" value="<?= $dm['kode_pg'] ?>" readonly class="hidden">
<?php } ?>

<label></label>
<?php  $mpl=mysqli_query($koneksi,"SELECT * FROM ujian_pg WHERE kode_pg='$_GET[id_upg]'");
                                                        ...
                                                        <table class="table table-striped table-bordered table-hover ">
                                                            ...
                                                            <?php 
                                                                  $i = 1;
                                                                    ...
                                                                    $tampil2=mysqli_query($koneksi,"SELECT * FROM `table_pg` WHERE kode_pg='$_GET[id_upg]' ");
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><a class="" onclick="return confirm('yakin ingin menghapus soal')" href='hapus_pg.php?id=<?php echo $dm['id_pg']; ?>'>Hapus</a></td>
