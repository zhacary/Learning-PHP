...
#myTable {
 ...
 <script type="text/javascript" src="DataTables/datatables.min.js"></script>
  <?php 
														        ...
														        $tampil=mysqli_query($koneksi,"SELECT * FROM `pg` INNER JOIN guru ON guru.nip = pg.nip WHERE kode_jurusan='$mm[kode_jurusan]' ORDER BY tanggal ASC ");
														...
														<table class="table table-striped table-bordered table-hover ">
															...
															<tbody>
																...
																<tr>
																	...
																	<td>
																		<a href="jawabpg1.php?id_pg=<?=$dm['kode_pg']?>" class="btn btn-sm btn-primary">Jawab</a>
																	</td>
																	<?php }else{ ?>
																	<td>
